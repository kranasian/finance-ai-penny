"""
Top-takeaways rubric checker optimizer — **insightfulness only**.

Grades only the **insightfulness** axis for `type=top_takeaways` outcomes.
...
Run from `finance-ai-penny` repo root:
  ...
  python3 active_experiments/hr_top_takeaways_insightfulness_optimizer.py
  python3 active_experiments/hr_top_takeaways_insightfulness_optimizer.py --test all
  python3 active_experiments/hr_top_takeaways_insightfulness_optimizer.py --test 0
  python3 active_experiments/hr_top_takeaways_insightfulness_optimizer.py --batch 1
"""
...
**Insightfulness rubric** (score 1–5):
- **5** — Strong synthesis across `<CONTEXTS>` contexts (ignore each rationalize’s `## Next steps`): prioritized, non-redundant, clearly communicates what mattered most and why (high signal; not a flat restatement).
...
TEST_CASES: list[dict[str, Any]] = [
  {
    "name": "high_insight_real_two_contexts_food_and_uncategorized",
    "batch": 1,
    "input": """<CONTEXTS>
...
""",
    "output": '{"score": 5, "notes": "Synthesizes the main drivers across both contexts into clear, non-redundant highlights/lowlights."}',
  },
  {
    "name": "low_insight_generic_restatement",
    "batch": 1,
    "input": """<CONTEXTS>
...
- Food spending was lower than last month.

## Lowlights

- Uncategorized spending was higher than the previous week.

</TOP_TAKEAWAYS>
""",
    "output": '{"score": 1, "notes": "Restates changes without synthesis, prioritization, or a clear takeaway."}',
  },
]
...
class TopTakeawaysInsightfulnessCheckerOptimizer:
  def __init__(
    self,
...
def main() -> None:
  ...
  opt = TopTakeawaysInsightfulnessCheckerOptimizer(
