...
3. **Category scope (updates)** — `category` on update **must equal** the active row slug; flag parent→leaf narrowing (e.g. `leisure` → `leisure_entertainment`). Parent→leaf narrowing alone → **3** (clear fixable), not **4**.
