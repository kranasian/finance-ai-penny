...
# Batch types for --batch: large_txn, uncat_txn, spend_vs_forecast, spend_vs_goal, mixed
BATCH_TYPES = ("large_txn", "uncat_txn", "spend_vs_forecast", "spend_vs_goal", "mixed")
...
TEST_CASES = [
    ...
    {
        "name": "spent_vs_goal_monthly_income_salary",
        "batch": "spend_vs_goal",
        "insight_input": [
            {
                "key": "46:spent_vs_goal",
                "insight": "Salary slightly exceeded your goal last month at $3,069.",
            }
        ],
        "ideal_response": "One item. key unchanged. income goal met/exceeded tone (positive, green), linked salary monthly, ≤100 chars.",
    },
    {
        "name": "spent_vs_goal_monthly_outflow_dining_out",
        "batch": "spend_vs_goal",
        "insight_input": [
            {
                "key": "2:spent_vs_goal",
                "insight": "Dining Out significantly exceeded your limit last month at $520.",
            }
        ],
        "ideal_response": "One item. key unchanged. outflow exceeded limit tone (warning, red), linked dining out monthly, ≤100 chars.",
    },
    {
        "name": "spend_vs_goal_weekly_outflow_within_limit",
        "batch": "spend_vs_goal",
        "insight_input": [
            {
                "key": "2:spend_vs_goal",
                "insight": "Dining Out was within your limit this week at $42.",
            }
        ],
        "ideal_response": "One item. key unchanged. outflow within limit tone (positive, green), linked dining out weekly, ≤100 chars.",
    },
    {
...
def get_tests_by_batch(batch_type: str):
    """Return list of (index, test_case) for the given batch type (large_txn, uncat_txn, spend_vs_forecast, spend_vs_goal, mixed)."""
...
def _print_usage():
    ...
    print("  Run by batch: --batch <large_txn|uncat_txn|spend_vs_forecast|spend_vs_goal|mixed>")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--batch", type=str, help="Run all tests in batch: large_txn, uncat_txn, spend_vs_forecast, spend_vs_goal, mixed")
