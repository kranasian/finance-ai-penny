...
Run from `finance-ai-penny` repo root:
  ...
  python3 active_experiments/rationalize_checker_insightful_optimizer.py --test all
  python3 active_experiments/rationalize_checker_insightful_optimizer.py --test high_insight_corrects_narrative_and_prioritizes
  python3 active_experiments/rationalize_checker_insightful_optimizer.py --test all --model gemini-flash-lite-latest
