...
def lookup_transactions(
  ...
  Host-produced row lines match top-transaction excerpts: ``- $N at Merchant as category_slug.``
  with whole-dollar amounts (no per-row dates; the lookup preamble states the window).
